<!DOCTYPE html><html lang="en">
  ...
  <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
    ...
    <title>Faskung PT. ASDP Indonesia Ferry Persero</title>
  </head>
  <body>
    ...
    <div class="container">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          ...
          <div class="content">
            <div>
              <img src="img/asdp3.png" class="imagess" alt="" height="150" width="-150" style="margin-top: 50px;" />
              <h3 style="margin-top: 10px;">ASDP Indonesia Ferry</h3>
            </div>
