...
?>
    ...
    <h1 class="text"><b>Update Data Pengeluaran Sementara Barang</b><br>Fasiltas Pendukung</h1>
    <div class="container">
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Tujuan</label>
                            <input type="text" value="<?php echo $data['tujuan']?>" name="tujuan" placeholder="Masukkan Tujuan" autocomplete="off" required>
                        </div>
