...
$sql1 = mysqli_query($koneksi, "SELECT * FROM pengeluaran WHERE nomor_barang='$_GET[kode]'");
$data1 = mysqli_fetch_array($sql1);
$jumlah1 = $data1['satuan_jumlah'] + $_POST['satuan_jumlah'];
$jumlah2 = $data1['jumlah'] + $_POST['jumlah'];

$kondisi = mysqli_query($koneksi, "SELECT * FROM pengeluaran");
...
if(isset($_POST['proses'])){
   ...
   //Hapus Data Lama
    mysqli_query($koneksi, "DELETE FROM pengeluaran WHERE nomor_barang='$_GET[kode]'");

    mysqli_query($koneksi, "INSERT INTO pengeluaran SET
    nama_barang = '$_POST[nama_barang]',
    merk_barang = '$_POST[merk_barang]',
    nomor_barang = '$_POST[nomor_barang]',
    nomor_seri = '$_POST[nomor_seri]',
    satuan_jumlah = $jumlah1,
    jumlah = $jumlah2,
    tujuan = '$_POST[tujuan]',
    ...
    nomor_barang = '$_POST[nomor_barang]',
    nomor_seri = '$_POST[nomor_seri]',
    satuan_jumlah = $jumlah_tarik1,
    jumlah = $jumlah_tarik2,
    ...
    echo "<script>swal({
        title: 'Berhasil',
        text: 'Barang Dikeluarkan Sementara!',
        icon: 'success',
        button: false,
        timer: 2000,
    }).then(function() {
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Tujuan</label>
                            <input type="text" value="Tujuan" name="tujuan" placeholder="Masukkan Tujuan" autocomplete="off" required>
                        </div>
