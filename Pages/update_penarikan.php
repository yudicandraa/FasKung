...
<?php 
include "../koneksi.php";
$sql = mysqli_query($koneksi, "SELECT * FROM penarikan WHERE nomor_barang='$_GET[kode]'");
$data = mysqli_fetch_array($sql);

if(isset($_POST['proses'])){
    mysqli_query($koneksi, "update penarikan set
...
?>
    ...
    <h1 class="text"><b>Update Data Penarikan Barang</b><br>Fasiltas Pendukung</h1>
    <div class="container">
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="buttons">
                        ...
                        <button onclick="location.href='penarikan.php'" type="button" id="button">
