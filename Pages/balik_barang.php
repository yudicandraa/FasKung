...
<?php 
include "../koneksi.php";
$sql = mysqli_query($koneksi, "SELECT * FROM pengeluaran WHERE nomor_barang='$_GET[kode]'");
...
$sql1 = mysqli_query($koneksi, "SELECT * FROM penempatan WHERE nomor_barang='$_GET[kode]'");
...
?>
    ...
    <h1 class="text"><b>Pengembalian Barang</b><br>Fasiltas Pendukung</h1>
    <div class="container">
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="buttons">
                        ...
                        <button onclick="location.href='pengeluaran.php'" type="button" id="button">
